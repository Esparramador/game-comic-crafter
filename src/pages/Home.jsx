...
export default function Home() {
  ...
  return (
    <div style={{
      height: "100vh", background: "#0f0a1e", color: "#e0e8ff",
      ...
      {splash && (
        <div style={{
          position: "fixed", inset: 0, zIndex: 9999, background: "#0f0a1e",
      ...
      {/* TOPBAR */}
      <div style={{
        flexShrink: 0, height: 56, background: "rgba(15,10,30,0.97)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}>
          <div style={{ position: "relative", cursor: "pointer", fontSize: "1.2rem" }}>
            🔔
            <div style={{ position: "absolute", top: 0, right: 0, width: 8, height: 8, borderRadius: "50%", background: "#e91e8c", border: "1px solid #0f0a1e" }} />
          </div>
          <div
      ...
      <div style={{
        ...
        {TABS.map(t => (
          <div key={t.id} onClick={() => setTab(t.id)} style={{
            ...
            <span>{t.label}</span>
            {tab === t.id && <div style={{ position: "absolute", bottom: 0, width: 22, height: 2, background: "#7c3aed", borderRadius: 2 }} />}
          </div>
        ))}
      </div>
